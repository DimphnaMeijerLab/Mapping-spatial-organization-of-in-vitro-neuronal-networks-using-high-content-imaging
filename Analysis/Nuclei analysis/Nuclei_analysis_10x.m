function [Glia_stats, Neuron_stats, LBW_Glia, LBW_Neurons, threshold]=Nuclei_analysis_10x(LBW_Dapi,LBW_AnkG,Dapi)
    %% 
    Neur_size=125; 
    overlap=0.5;
    %Remove rubbish and watershed Nuclei
    LBW_Dapi=firstfilter(LBW_Dapi,[50,950],1);
    ...
    [LBW_Neurons, ~, threshold]=brightsizefilteralt_10x(LBW_Neurons,Dapi);
